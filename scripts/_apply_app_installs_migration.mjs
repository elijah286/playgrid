...
const sqlPath = fileURLToPath(
  new URL("../supabase/migrations/20260529120000_app_installs.sql", import.meta.url),
);
...
const version = "20260529120000";
const name = "app_installs";
try {
  await client.query(
...
const checks = [
  ...
  "select column_name, data_type from information_schema.columns where table_schema='public' and table_name='app_installs' order by ordinal_position",
];
