      ...
      return [
        {
          ...
          variant,
          players: [
            mkDefender("d_cb1", "CB", "CB", 0.18, 0.50),
            mkDefender("d_cb2", "CB", "CB", 0.50, 0.50),
            mkDefender("d_cb3", "CB", "CB", 0.82, 0.50),
            mkDefender("d_fs", "S", "FS", 0.50, 0.70),
          ],
        },
        {
          key: "flag4_cover2",
          ...
          variant,
          players: [
            mkDefender("d_cb1", "CB", "CB", 0.25, 0.50),
            mkDefender("d_cb2", "CB", "CB", 0.75, 0.50),
            mkDefender("d_fs", "S", "FS", 0.25, 0.70),
            mkDefender("d_ss", "S", "SS", 0.75, 0.70),
          ],
        },
        {
          key: "flag4_press",
          ...
          variant,
          players: [
            mkDefender("d_cb1", "CB", "CB", 0.18, 0.44),
            mkDefender("d_cb2", "CB", "CB", 0.50, 0.44),
            mkDefender("d_cb3", "CB", "CB", 0.82, 0.44),
            mkDefender("d_fs", "S", "FS", 0.50, 0.70),
          ],
        },
      ];
      ...
      return [
        ...
        },
        {
          ...
          players: [
            ...
            mkDefender("d_lb", "LB", "M", 0.50, 0.56),
            mkDefender("d_cb2", "CB", "CB", 0.85, 0.56),
            mkDefender("d_fs", "S", "FS", 0.30, 0.68),
            mkDefender("d_ss", "S", "SS", 0.70, 0.68),
          ],
        },
        {
          key: "flag5_press",
          ...
          variant,
          players: [
            mkDefender("d_cb1", "CB", "CB", 0.15, 0.44),
            mkDefender("d_lb", "LB", "M", 0.50, 0.44),
            mkDefender("d_cb2", "CB", "CB", 0.85, 0.44),
            mkDefender("d_fs", "S", "FS", 0.30, 0.68),
            mkDefender("d_ss", "S", "SS", 0.70, 0.68),
          ],
        },
      ...
      return [
        {
          ...
          variant,
          players: [
            mkDefender("d_cb1", "CB", "CB", 0.10, 0.56),
            mkDefender("d_nb1", "S", "NB", 0.32, 0.56),
            mkDefender("d_nb2", "S", "NB", 0.68, 0.56),
            mkDefender("d_cb2", "CB", "CB", 0.90, 0.56),
            mkDefender("d_fs", "S", "FS", 0.35, 0.68),
            mkDefender("d_ss", "S", "SS", 0.65, 0.68),
          ],
        },
        {
          key: "flag6_cover3",
          ...
          variant,
          players: [
            mkDefender("d_nb1", "S", "NB", 0.25, 0.56),
            mkDefender("d_lb", "LB", "M", 0.50, 0.56),
            mkDefender("d_nb2", "S", "NB", 0.75, 0.56),
            mkDefender("d_cb1", "CB", "CB", 0.15, 0.72),
            mkDefender("d_fs", "S", "FS", 0.50, 0.76),
            mkDefender("d_cb2", "CB", "CB", 0.85, 0.72),
          ],
        },
        {
          key: "flag6_press",
          ...
          variant,
          players: [
            mkDefender("d_cb1", "CB", "CB", 0.10, 0.44),
            mkDefender("d_nb1", "S", "NB", 0.32, 0.44),
            mkDefender("d_nb2", "S", "NB", 0.68, 0.44),
            mkDefender("d_cb2", "CB", "CB", 0.90, 0.44),
            mkDefender("d_fs", "S", "FS", 0.35, 0.68),
            mkDefender("d_ss", "S", "SS", 0.65, 0.68),
          ],
        },
      ...
      return [
        {
          ...
          variant,
          players: [
            mkDefender("d_de1", "DL", "DE", 0.30, 0.43),
            mkDefender("d_dt1", "DL", "DT", 0.42, 0.43),
            mkDefender("d_dt2", "DL", "DT", 0.54, 0.43),
            mkDefender("d_de2", "DL", "DE", 0.70, 0.43),
            mkDefender("d_sam", "LB", "SL", 0.30, 0.50),
            mkDefender("d_mlb", "LB", "ML", 0.50, 0.50),
            mkDefender("d_will", "LB", "WL", 0.70, 0.50),
            mkDefender("d_cb1", "CB", "CB", 0.08, 0.46),
            mkDefender("d_cb2", "CB", "CB", 0.92, 0.46),
            mkDefender("d_fs", "S", "FS", 0.38, 0.76),
            mkDefender("d_ss", "S", "SS", 0.62, 0.76),
          ],
        },
        {
          ...
          variant,
          players: [
            mkDefender("d_de1", "DL", "DE", 0.36, 0.43),
            mkDefender("d_nt", "DL", "NT", 0.50, 0.43),
            mkDefender("d_de2", "DL", "DE", 0.64, 0.43),
            mkDefender("d_olb1", "LB", "OL", 0.24, 0.47),
            mkDefender("d_ilb1", "LB", "IL", 0.42, 0.50),
            mkDefender("d_ilb2", "LB", "IL", 0.58, 0.50),
            mkDefender("d_olb2", "LB", "OL", 0.76, 0.47),
            mkDefender("d_cb1", "CB", "CB", 0.08, 0.46),
            mkDefender("d_cb2", "CB", "CB", 0.92, 0.46),
            mkDefender("d_fs", "S", "FS", 0.38, 0.76),
            mkDefender("d_ss", "S", "SS", 0.62, 0.76),
