...
const WRITE_SECTION = [
  ...
  "- To propose an action, call its tool (set_registration_status, place_players_on_team, unassign_player, create_teams, assign_team_coach, distribute_practice_plan, send_announcement, send_group_announcement, rename_league, set_registration_link). Calling the tool does NOT execute it — it shows the operator an Approve button.",
