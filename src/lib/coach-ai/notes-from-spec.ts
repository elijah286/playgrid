...
const ROUTE_CUES_BY_COVERAGE: Record<string, Record<string, string>> = {
  ...
  fade: {
    "cover 0": "one-on-one back-shoulder before help arrives — throw it up-and-away from the trail leverage",
    "cover 1": "vs press man — stack the corner's outside hip; ball placed back-shoulder where only you can adjust",
    "cover 2": "attack the deep-sideline honey hole behind the squat corner and in front of the half safety",
    "cover 3": "hold the deep-third corner with the stem, then win back-shoulder on his outside hip",
    man: "back-shoulder vs tight leverage — the throw beats the coverage, not the route",
  },
  in: {
    "cover 1": "vs man — sell vertical, snap flat inside; the ball beats the driving defender at the break",
    "cover 2": "sit in front of the two safeties and behind the underneath defenders — face the QB",
    "cover 3": "settle in the hole between the hook defenders — under the middle, over the underneath",
    "cover 4": "work in front of the safety carry — sit at 8-10 in the void the quarters defenders vacate",
    man: "sharp inside break — beat his leverage, catch and turn upfield",
  },
  "quick out": {
    "cover 0": "hot vs blitz — snap to the sideline and get the ball out now",
    "cover 1": "vs off-man — win the foot race outside; ball arrives at the break before he drives",
    "cover 2": "under the squat corner to the sideline — eyes back fast before he jumps it",
    "cover 3": "beat the curl/flat defender to the boundary on his outside leverage",
    man: "speed cut to the sideline — no gather, ball out on rhythm",
  },
  "z-out": {
    "cover 0": "double-move vs man — sell the inside cut, break back out; it needs time, so protect it",
    "cover 1": "the inside fake turns the corner's hips, then break back to the sideline behind him",
    man: "man-beater — sell the first break hard so he commits inside",
    zone: "wasted vs disciplined zone — the defender won't chase the fake; check it down",
  },
  "z-in": {
    "cover 0": "double-move vs man — sell the out, break back inside behind him; it needs a beat, so protect it",
    "cover 1": "the outside fake widens the corner, then cross his face back to the middle",
    man: "man-beater — commit the defender outside with a hard first break",
    zone: "not the call vs disciplined zone — the read here is man leverage",
  },
  "hook in": {
    "cover 1": "vs off-man — stem to his cushion, hook back inside as he opens his hips",
    "cover 2": "settle inside the underneath defenders — face the QB in the window behind the LBs",
    "cover 3": "hook into the hole between the hook and curl defenders — sit and show your numbers",
    man: "reverse back inside when the defender's weight carries him upfield",
  },
  "hook out": {
    "cover 1": "vs off-man — stem to his cushion, hook back to the sideline as he keeps retreating",
    "cover 2": "come back to the boundary under the squat corner — clean vs two-deep",
    "cover 3": "hook outside the curl/flat defender toward the sideline — get eyes back fast",
    man: "reverse back to the sideline when the corner stops bailing",
  },
  "quick in": {
    "cover 0": "hot vs blitz — quick inside release, look fast on the inside hip",
    "cover 1": "vs off-man — beat him inside with the quick cut, ball out on the third step",
    "cover 2": "slide into the window between the underneath defenders — sit vs zone",
    "cover 3": "find the inside void the apex defender opens — quick and on rhythm",
    man: "quick inside cut — win leverage and get the ball fast",
  },
  "skinny post": {
    "cover 1": "vs single-high — bend under the free safety, splitting him from the post-safety corner",
    "cover 2": "split the two safeties down the middle — into the deep void between the halves",
    "cover 3": "the money read — bend between the deep-third corner and the middle-third safety",
    "cover 4": "attack the inside shoulder of the quarters safety — bend into the seam void",
    man: "sell vertical and bend inside a hair — the near-vertical stem is hard to cover",
  },
  comeback: {
    "cover 1": "vs off-man — push his cushion vertical, then snap back down to the sideline where he can't recover",
    "cover 2": "come back outside under the deep-half safety, on top of the squat corner's zone",
    "cover 3": "stress the deep-third corner vertically, then comeback to the boundary on his outside hip",
    man: "win on the cushion — the harder he bails, the wider the comeback window",
  },
  sit: {
    "cover 0": "hot vs blitz — settle early at 5, square up, ball on rhythm",
    "cover 2": "sit behind the underneath defenders and in front of the safeties — soft spot",
    "cover 3": "settle in the hole outside the hook defender — face the QB and show hands",
    "cover 4": "sit under the quarters bail — the underneath is soft with only three short defenders",
    zone: "find the void, stop, and face the QB — it's a spacing route",
  },
  spot: {
    "cover 1": "vs man — the angled release rubs off traffic; settle facing the QB if he trails",
    "cover 2": "spot into the window behind the OLB and in front of the safety — the snag staple",
    "cover 3": "settle in the spot the hook and curl defenders vacate — deliberate turn-back, ready hands",
    zone: "deliberate settle in the soft spot — deeper and more patient than a hitch",
  },
  arrow: {
    "cover 1": "vs man — outrun the linebacker to the flat; the angle beats his leverage",
    "cover 2": "arrow under the squat corner — ball out before the flat defender expands",
    "cover 3": "stretch the curl/flat defender horizontally — if he sinks to the curl, the arrow is open",
    zone: "gain depth gradually to the flat — the low half of a high-low",
  },
  wheel: {
    "cover 1": "vs man — a linebacker can't run the wheel with a back; win up the sideline",
    "cover 3": "run up behind the curl/flat defender as the deep-third corner sits — sideline seam",
    "cover 4": "test the quarters corner's wheel discipline — go if he squats on the flat fake",
    man: "the flat fake holds the linebacker, then beat him vertical up the boundary",
  },
  "out & up": {
    "cover 1": "vs man — sell the out to freeze his hips, then take it up the sideline",
    "cover 2": "punish a squat/cloud corner who jumps the out — up the boundary behind him",
    "cover 3": "vs a curl/flat defender who drives the out — release up over the top",
    man: "double-move — the harder he bites the out, the wider the up",
  },
  whip: {
    "cover 0": "vs blitz man — the out-fake and whip-back beats tight leverage; look fast inside",
    "cover 1": "vs man — sell the out hard, then whip back across his face to the inside",
    man: "misdirection man-beater — commit the defender outside, then snap back in",
    zone: "vs zone the whip settles inside the underneath defenders — sit and face the QB",
  },
  "stop & go": {
    "cover 1": "vs off-man — sell the hitch to bait his drive, then take it deep on his recovery",
    "cover 3": "bait the deep-third corner up on the hitch, then stack and run past him",
    man: "double-move — the harder he jumps the stop, the cleaner the go",
    "cover 0": "not the call vs zero pressure — too slow-developing; hit the quick game instead",
  },
  bubble: {
    "cover 0": "vs blitz — a pre-snap numbers read; throw it if the box is loaded and the perimeter is light",
    "cover 3": "attack the vacated flat when the curl/flat defender widens or the corner bails deep",
    "cover 4": "quick perimeter vs light-box quarters — catch it and get vertical outside the numbers",
    man: "throw it when the overhang defender is aligned inside — you have the leverage and numbers",
  },
};
