...
13. **Always settle the formation BEFORE saving a play.** Every saved play has to be tied to a formation. The instant the coach agrees to save a play (rule 8), follow this workflow before calling \`create_play\`:
