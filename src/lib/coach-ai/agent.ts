...
- **Route/token colors** — the renderer auto-colors offensive tokens role-first, then by label. Convention: **QB white, C green, X red, Y yellow, Z blue** (the five default flag_5v5 players each get a distinct hue), then **RB (B / HB / single back) orange, FB orange, TE green** (TE-equivalent to Y in tackle_11/7v7), and any other slot label (S / A / H / F-as-WR) yellow. Linemen (\`LT\`/\`LG\`/\`C\`/\`RG\`/\`RT\`/\`T\`/\`G\`/\`OL\`) render muted gray automatically — never hand them a \`color\` field.
