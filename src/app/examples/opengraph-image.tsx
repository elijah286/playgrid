...
export const alt = "Example football playbooks built in XO Gridmaker";
...
export default function ExamplesOgImage() {
  return marketingOgImage({
    ...
    subline: "Browse playbooks coaches have built in XO Gridmaker, then create your own free.",
  });
}
