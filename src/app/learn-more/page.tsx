    ...
    images: [
      {
        ...
        width: 1440,
        height: 900,
        alt: "XO Gridmaker editor with a flag-football play being drawn",
      },
    ],
  },
  twitter: {
...
// breadcrumbs show "XO Gridmaker › Tour".
const STRUCTURED_DATA = [
  {
    "@context": "https://schema.org",
    "@type": "SoftwareApplication",
    name: "XO Gridmaker",
    alternateName: "XO Gridmaker — youth football playbook",
        ...
        <Reveal>
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-lg text-muted">
              A few things set XO Gridmaker apart from the playbook apps,
      ...
      <div className="mx-auto max-w-6xl px-6">
        <Reveal>
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-lg text-muted">
              These are actual XO Gridmaker playbooks built by coaches. Every
          ...
          <Reveal>
            <div className="overflow-hidden rounded-3xl shadow-[var(--shadow-elevated)] ring-1 ring-black/10">
              <Image
                ...
                alt="Printed call sheet and four wristbands on the field — generated from a real XO Gridmaker playbook"
                width={1400}
                height={1050}
      ...
      <div className="mx-auto max-w-3xl px-6 text-center">
        <Reveal>
          ...
          <p className="mt-6 text-lg text-muted">
            XO Gridmaker is built by an active flag, youth tackle, and 7v7
