 ...
 *  dialog. Returns only the narrow ReferralPromo (active, perReferralLabel,
 *  recipientTrialDays, capAwards) — never the raw ReferralConfig, which carries
 *  the staged-rollout test-cohort emails. `active` respects the test cohort, so
 *  testers get accurate copy pre-launch. */
